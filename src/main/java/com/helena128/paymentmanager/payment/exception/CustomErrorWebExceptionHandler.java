...
public class CustomErrorWebExceptionHandler extends AbstractErrorWebExceptionHandler {
    ...
    private Map<String, Object> getErrorAttributes(Map<String, Object> errorPropertiesMap) {
        return Map.of(ResponseConstants.MESSAGE.getValue(), errorPropertiesMap.get(ResponseConstants.MESSAGE.getValue()));
    }
